...
def get_model(output_channels=3, size=224, name="SegNet", kernel = 3, ActFunction = 'selu'):
    ...
    Out = Conv2D(output_channels, 1, activation = tf.keras.activations.softmax, name='OutputLayer')(Norm26)
